odoo.define("sale_orders_product.tour", function (require) {
"use strict";
/**
 * Add custom steps to take products and sales order into account
 */
var tour = require('web_tour.tour');
require('sale_orders_product.mobile_tour');
//require('industry_fsm.tour');
var core = require('web.core');
var _t = core._t;

var fsmStartStepIndex = _.findIndex(tour.tours.mobile_fsm_tour.steps, function (step) {
    return (step.id === 'fsm_start');
});

tour.tours.mobile_fsm_tour.steps.splice(fsmStartStepIndex + 1, 0, {
...
var fsmCreateInvoiceStepIndex = _.findIndex(tour.tours.mobile_fsm_tour.steps, function (step) {
    return (step.id === 'fsm_invoice_create');
});

tour.tours.mobile_fsm_tour.steps.splice(fsmCreateInvoiceStepIndex + 1, 0, {
